...
const HomeSetting = (props) => {
  ...
  return (
    ...
    >
      ...
      <Form.Item label="无人时自动暂停" valuePropName="checked" tooltip="开启后没人世界也正常运行" name='pause_when_nobody'>
        <Switch checkedChildren="开启" unCheckedChildren="关闭" defaultChecked />
      </Form.Item>

      <Form.Item label="房间密码" name='clusterPassword'>
        <Input.Password placeholder="最大长度20" maxLength={20} style={{ width: '50%', }} />
      </Form.Item>
      <Form.Item
        label="令牌"
        name='token'
